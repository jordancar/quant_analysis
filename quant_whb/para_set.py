...
stock_pool_9=['600011.SH', '600019.SH', '600020.SH', '600026.SH', '600027.SH','600028.SH', '600029.SH', '600030.SH', '600031.SH']
class back_test(object):
    stock_pool=stock_pool
    stock_pool_9=stock_pool_9
    def __init__(self,para_window=90,start_time='2015-01-01',end_time='2018-12-01',hold_days=15,strategy='',torlence_profit=0.05,torlence_lost=0.10,operate_days=5,operate_tm=''):
